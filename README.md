...
<br>
<img src="https://img.shields.io/badge/-Java-020617?style=flat-square&logo=openjdk&logoColor=orange" height="19"/>
<img src="https://img.shields.io/badge/-Spring_Boot-020617?style=flat-square&logo=springboot&logoColor=6DB33F"/>
...
<ul>
  <li>José Maurício da Silva Júnior — Algoritmos e Estrutura de Dados</li>
  <li>Raoni Monteiro de Oliveira — Infraestrutura de Software (SO)</li>
  <li>Robson Godoi de Albuquerque Maranhão — Projeto 3</li>
  <li>Maurício da Motta Braga — Programação Orientada a Objetos</li>
  <li>Luiz Filipe Guimarães Novaes — Infraestrutura de Comunicação (RSD)</li>
  <li>André Luiz da Silva Xavier — Estatística e Probabilidade</li>
</ul>
